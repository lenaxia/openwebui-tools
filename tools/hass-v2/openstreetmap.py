...
class Tools:
    class Valves(BaseModel):
        user_agent: str = Field(
            default="",
            description="Unique user agent to identify your OSM API requests.",
        )
        ...
        instruction_oriented_interpretation: bool = Field(
            default=True,
            description=(
                "Give detailed result interpretation instructions to the model. "
        ...
        ors_api_key: Optional[str] = Field(
            default=None,
            description=(
                "Provide an Open Route Service API key to calculate "
        ...
        status_indicators: bool = Field(
            default=True, description=("Emit status update events to the web UI.")
        )
        pass
    ...
    async def find_address_for_coordinates(
        self, latitude: float, longitude: float, __event_emitter__
    ) -> str:
        """
        ...
        return await self.find_specific_place(
            f"{latitude}, {longitude}", __event_emitter__
        )

    async def find_store_or_place_near_coordinates(
        self,
        store_or_business_name: str,
        latitude: float,
        longitude: float,
        __event_emitter__,
    ) -> str:
    ...
    async def find_specific_place(
        self, address_or_place: str, __event_emitter__
    ) -> str:
        """
    ...
    async def find_bakeries_near_place(
        self, __user__: dict, place: str, __event_emitter__
    ) -> str:
        """
    ...
    def find_other_things_near_place(
        self, __user__: dict, place: str, category: str
    ) -> str:
        """
